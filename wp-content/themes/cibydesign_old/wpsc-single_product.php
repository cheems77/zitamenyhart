		...
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			<div class="single_product_display product_view_<?php echo wpsc_the_product_id(); ?>">
				<div class="textcol">
					...
					<div class="imagecol">
					<span class="category_title"><?php echo wpsc_the_category_title(); ?></span>
						...
						<?php endif ;?>
							...
							<div class="wpsc_product_price">
								<?php if(wpsc_product_is_donation()) : ?>
									...
									<input type='hidden' id='donation_price_<?php echo wpsc_the_product_id(); ?>' name='donation_price' value='<?php echo $wpsc_query->product['price']; ?>' size='6' />
									<br />
								...
								<?php echo __('Price', 'wpsc'); ?>:
									<?php if(wpsc_product_on_special()) : ?>
										<span class='oldprice'> <?php echo wpsc_product_normal_price(get_option('wpsc_hide_decimals')); ?></span><br />
									<?php endif; ?>
									<span id="product_price_<?php echo wpsc_the_product_id(); ?>" class="pricedisplay"><?php echo wpsc_the_product_price(get_option('wpsc_hide_decimals')); ?></span><br/>
