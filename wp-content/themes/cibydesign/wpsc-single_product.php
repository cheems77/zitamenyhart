		...
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			<div class="single_product_display product_view_<?php echo wpsc_the_product_id(); ?>">
				<div class="textcol">
					...
					<h3 class="prodtitle"><span><?php echo wpsc_the_product_title(); ?></span></h3>
							<?php				
...
<div class="wpsc_product_price">
							<?php if(wpsc_product_is_donation()) : ?>
								<input type='hidden' id='donation_price_<?php echo wpsc_the_product_id(); ?>' name='donation_price' value='0' size='6' />
							<br />
							<?php else : ?>
...
<!-- THIS IS THE QUANTITY OPTION MUST BE ENABLED FROM ADMIN SETTINGS -->
					<?php if(wpsc_has_multi_adding() && (wpsc_the_product_price() > 0)): ?>
						<fieldset>
					...
					<?php if((get_option('hide_addtocart_button') == 0) && (get_option('addtocart_or_buynow') !='1')) : ?>
						<?php if(wpsc_product_has_stock()) : ?>
							<?php if(wpsc_product_external_link(wpsc_the_product_id()) != '') : ?>
										...
										<?php elseif(wpsc_the_product_price() == '' || is_null(wpsc_the_product_price()) ) : ?>
										<a href="http://zitamenyhart.com/contact" title="Contact Us Regading this Item">Contact Us Regarding this Item</a>
										<?php else: ?>
