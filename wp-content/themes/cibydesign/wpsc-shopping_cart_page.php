...
<table class="productcart">
	<tr class="firstrow" style="visibility: hidden;">
...
<?php
	...
	echo __('You currently have no items in your cart.', 'wpsc') . " <a href='http://zitamenyhart.com/objects'>" . __('View our products', 'wpsc') . "</a>";
endif;
